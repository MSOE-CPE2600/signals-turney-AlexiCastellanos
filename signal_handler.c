 ...
 * Description: Sets a signal handler for SIGINT. The handler prints a message and allows the program to continue running.
 *
...
/**
 * Signal handler for SIGINT - prints a message and continues execution
 */
...
/**
 * Signal handler for SIGTERM - prints a message and exits the program
 */
